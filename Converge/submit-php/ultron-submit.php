...
$event='ULTRON';
$eventname='Ultron - The Manual Robotics Competition';
...
$ses_sql=mysqli_query($connection,"SELECT * FROM robotics WHERE event_name='$event' and email_head='$email1' or event_name='$event' and phone_head='$phone1' or event_name='$event' and team_name='$team_name'");
 if($ses_sql->num_rows==0)
 {
     ...
     if (mysqli_query($connection,$sql) == TRUE) {
        ...
        $message2.= "<br>On $date <br>Reporting Time: $reportime <br>Event starts at $eventime beside new cafe";
        ...
        $message3.= "<br>Event Coordinators<br>Vaibhav Agarwal +917838323105 <br>Regards JIIT Converge Team <br><br> Please keep checking jiitconverge.com for updates.";
        $header = "From: ".$admin; 
