...
$ses_sql=mysqli_query($connection,"SELECT * FROM dramatics WHERE email_id='$email1' and event1='$event' or contact='$phone1' and event1='$event'");
 if($ses_sql->num_rows==0)
 {
    ...
    if (mysqli_query($connection,$sql) == TRUE) {
        ...
        $message3.= "<br>Event Coordinator <br>Akshita : +91-8527348631 <br><br>Regards JIIT Converge Team ";
...
//break; 
//}
     echo "<div style='width:60%;height:60%;margin:20% auto;font-size:150%;font-family:'Lato';word-wrap:normal'>This email or contact number is already registered. Please try again with another emailID/contact.</div>";
}
$connection->close();
?>