...
$event='PLAY PAUSE REWIND';
$eventname='Play Pause Rewind - Online Film Making Competition ';
...
$ses_sql=mysqli_query($connection,"SELECT * FROM sports WHERE event_name='$event' and email_id ='$email1' or event_name='$event' and phone_participant='$phone1'");
 ...
 {
     // new record
     $sql = "INSERT INTO sports VALUES ('','$event','$college','$fname1','$phone1','$email1','$team_members','$year')";
     if (mysqli_query($connection,$sql) == TRUE) {
        ...
        $message2.= "<br>Submission deadline: $date ";
