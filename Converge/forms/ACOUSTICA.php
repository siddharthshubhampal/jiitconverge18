...
<form class="cmxform" id="event-form" name="acoustic" method="POST" >
<fieldset>
...
<label>Year</label>  
                        <select style="width: 236px" id="year" name="year">
                          <option value="FIRST">Undergraduate 1st year</option>
                          <option value="SECOND">Undergraduate 2nd year</option>
                          <option value="THIRD">Undergraduate 3rd year</option>
                          <option value="FORTH">Undergraduate 4th year</option>
...
<p>
    <label for="accompanists">Accompanists (if any)</label>
    <input id="accompanists" type="text" name="accompanists" />
</p>
