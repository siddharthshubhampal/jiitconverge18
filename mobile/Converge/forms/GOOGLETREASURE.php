<div style='width:60%;height:60%;margin:20% auto;font-size:150%;text-align:center;font-family:Lato;word-wrap:normal'>Registrations Closed. Looks like we hit our maximum capacity for this event.<br><br> For enquiry, contact:<br>Harshit +91-7565033339</div>
<!--
...
<div class="hidden event-name">googletreasure</div>
<form class="cmxform" id="event-form" name="googletreasure"  method="POST" >
<fieldset>
