<div style='width:60%;height:60%;margin:20% auto;font-size:150%;text-align:center;font-family:Lato;word-wrap:normal'>Registrations Closed. Looks like we hit our maximum capacity for this event.<br><br> For enquiry, contact:<br>Samarth +91-8447897332</div>
<!--
...
<div id="participant2" style="display:inline-block;">
<p>
<div class="open-arrow"></div><label for="cemail">Personal Details - Participant 2</label><br>
<label for="cemail">Full Name</label>
<input id="cemail2" type="text" name="firstname2"  minlength="2" pattern="[A-Za-z-']+\s[A-Za-z-']+" title="Firstname Lastname" required/>
</p>
...
<p>
<label>Year</label>  
                        <select style="width: 236px" id="year2" name="year2" required>
                          <option value="1">Undergraduate 1st year</option>
                          <option value="2">Undergraduate 2nd year</option>
                          <option value="3">Undergraduate 3rd year</option>
                          <option value="4">Undergraduate 4th year</option>
...
<input id="course2" name="course2" minlength="2"  type="text" pattern="[A-Za-z,-_ ]{1,60}" required>
</p>

<p>
<label for="ccol">College</label>
<input id="ccol2" name="college2" minlength="2"  type="text" pattern="[A-Za-z,-_ ]{1,60}" required>
</p>

<p>
<label for="cemail">Phone</label>
<input id="phone2"  name="phone2" type="type" minlength="10" maxlength="10" pattern="[789]{1}[0-9]{9}" required>
</p>
