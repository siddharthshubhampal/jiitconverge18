...
<form class="cmxform" id="event-form" name="youth-marathon" method="POST" >
<fieldset>

<p>
<label for="ccol" style="width:48%">Name of School/College Attended</label>
<input id="ccol" name="college" minlength="2"  type="text" pattern="[A-Za-z,-_ ]{1,60}">
</p>
...
<label>Year</label>  
                        <select style="width: 236px" id="year" name="year">                          
                          <option value="5">Not In College Yet</option>
                          ...
                          <option value="6">No Longer a Student </option>       
                       </select>
</p>
