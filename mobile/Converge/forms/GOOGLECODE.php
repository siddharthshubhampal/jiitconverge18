<div style='width:60%;height:60%;margin:20% auto;font-size:150%;text-align:center;font-family:Lato;word-wrap:normal'>Online Registrations Closed. Offline Registrations on 4th Feb, 9.15 A.M. onwards.</div>
...
<div class="hidden event-name">googlecode</div>
<form class="cmxform" id="event-form" name="googlecode"  method="POST" >
<fieldset>
