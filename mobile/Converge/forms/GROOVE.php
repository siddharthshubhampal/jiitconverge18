...
<div class="hidden event-name">groove</div>
<form class="cmxform" id="event-form" name="groove"  method="POST" >
<fieldset>
...
<p>
<label for="cemail" style="width:48%">Video Link of Past Performance</label>
...
<p>
<div class="open-arrow"></div><label for="cemail">Vice President's Details</label><br>
<label for="cemail">Full Name</label>
