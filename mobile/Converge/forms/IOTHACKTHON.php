<div style='width:60%;height:60%;margin:20% auto;font-size:150%;text-align:center;font-family:Lato;word-wrap:normal'>Registrations Closed. Looks like we hit our maximum capacity for this event.<br><br> For enquiry, contact:<br>Jai +91-8368207612</div>
...
<div class="hidden event-name">iothackathon</div>
<form class="cmxform" id="event-form" name="iothackathon"  method="POST" >
<fieldset>
...
<select name="team_members" id="team_members">
                                                                      ...
                                                                      <option id="2" value="2">2</option>                                                                  																	  <option id="3" value="3">3</option>
