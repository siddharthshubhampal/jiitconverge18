...
<p>
<label for="cemail" style="width:60%">Society Head's E-Mail</label>
...
<p>
<label for="cemail" style="width:60%">Society Representative's E-Mail</label>
...
<p>
    <label style="width:60%">Require Transportation from Metro</label>  
                        <select style="width: 96px" id="transport" name="transport">
