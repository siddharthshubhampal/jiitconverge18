...
<p>
				...
				<select name="event" id="event">
                    <option id="3x3 Rubik's Cube" value="3x3 Rubik's Cube">3x3 Rubik's Cube</option>
					<option id="Tv Show Quiz" value="Tv Show Quiz">Tv Show Quiz</option>  
					<option id="Logo Quiz" value="Logo Quiz">Logo Quiz</option>  
					<option id="Tug Of War" value="Tug Of War">Tug Of War</option>  
					<option id="Treasure Hunt" value="Treasure Hunt">Treasure Hunt</option>  
					<option id="Roadies" value="Roadies">Roadies</option>  
					<option id="Minute to win it" value="Minute to win it">Minute to win it</option>  
					<option id="Blind Date" value="Blind Date">Blind Date</option>  
					<option id="Triple Pair Dance" value="Triple Pair Dance">Triple Pair Dance</option>  
</select>
</p>
