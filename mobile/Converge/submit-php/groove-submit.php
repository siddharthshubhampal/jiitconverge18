...
$event='WESTERN';
$eventname='Groove - Western Dance - Dance Competition';
...
$date= ' 4th FEB 2017 ';
$eventime= ' 12:00 P.M. ';
$reportime= ' 09:00 - 10:30 A.M. ';
$ses_sql=mysqli_query($connection,"SELECT * FROM western_dance WHERE email_id='$email1' or team_name='$teamname'");
 if($ses_sql->num_rows==0)
 {
     // new record with a new team name or email id
     $sql = "INSERT INTO western_dance VALUES ('$college','$teamname','$url','$fname1','$phone1','$fname2','$phone2','$team_members','$email1')";
    ...
    if (mysqli_query($connection,$sql) == TRUE) {
        ...
        $message3.= "<br>Event Coordinator<br>Kriti Srivastava +91-8826544048 <br><br>Regards JIIT Converge Team ";
        $header = "From: ".$admin;
        ...
        $message.= "<br>Number of members in the team: $team_members <br>Video Link of Past Performance: $url <br>College: $college  <br>President's Details <br>NameL: $fname1<br>Mail-ID: $email1 <br>Contact No.: $phone1 <br><br>Vice President's Details: <br>Name:$fname2 Contact No:$phone2";
...
//break; 
//}
     echo "<div style='width:60%;height:60%;margin:20% auto;font-size:150%;font-family:'Lato';word-wrap:normal'>A team with that name or emailID is already registered. Please try again with different email/team name.</div>";
}
