...
//$team;
$date= 'FEB 4, 2017';
$eventime= ' 11:00 A.M (May change)';
$reportime= ' 10:45 A.M (May change)';
$ses_sql=mysqli_query($connection,"SELECT * FROM gdg_events WHERE event_name='$event' and email_id='$email1' or event_name='$event' and phone_participant='$phone1'");
 if($ses_sql->num_rows==0)
 {
     ...
     if (mysqli_query($connection,$sql) == TRUE) {
        ...
        $message3.= "<br>Event Coordinator<br>Pranav Sharma +918376003776 <br><br>Regards JIIT Converge Team <br><br> Please Keep checking jiitconverge.com for any updates.";
        $header = "From: ".$admin; 
